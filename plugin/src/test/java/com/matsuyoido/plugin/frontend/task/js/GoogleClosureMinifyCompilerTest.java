...
public class GoogleClosureMinifyCompilerTest {
    ...
    private GoogleClosureMinifyCompiler compiler = new GoogleClosureMinifyCompiler(false);
            ...
            if (file.getName().equals("nest")) {
                assertThat(file.listFiles()).allSatisfy(nestFile -> {
                    assertThat(nestFile).isFile()
                                        ...
                                        .hasContent("'use strict';(function(){console.log(\"hello world\")})();");
                }).hasSize(1);
            } else {
                assertThat(file).isFile()
                                .satisfies(f -> assertThat(f.getName()).endsWith(".min.js"))
                                .hasContent("'use strict';function Test(){this.name=0};");
            }
